...
route('*', function() {
  ...
  editor = new MediumEditor(els, {
          ...
          toolbar:
          {
              buttons:
              [
                'bold', 'italic', 'underline', 'strikethrough', 'quote', 'anchor', 'image', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'superscript', 'subscript', 'orderedlist', 'unorderedlist', 'pre', 'h2', 'h3', 'anchor', 'superscript', 'subscript', 'reference', 'footnote', 'hr', 'removeFormat', 
              ],
          ...
          {
            'hr': new MediumButton({
              label: '<i class="fa fa-terminal" title="add new line"></i>',
              start: '<hr />',
              end: ' 1'
            }),
            ...
            'footnote': new MediumButton({
              ...
              action: function(html, mark)
                {
                  alert(html); 
                  return '<a data-link="footnote" href="#ref1">' + html + '</a>';
                }
            }),
