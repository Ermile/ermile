...
route('*', function() {
	...
	editor = new MediumEditor(els, {
		...
		toolbar:
		{
			buttons:
			[
			'bold', 'italic', 'underline', 'quote', 'anchor', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'orderedlist', 'unorderedlist', 'h2', 'h3', 'anchor', 'superscript', 'pre', 'removeFormat',
			],
			autoLink: true,
