...
class postmetas 
{
	...
	public $post_id         = array('null' =>'NO',  'show' =>'YES', 'label'=>'post',          'type' => 'bigint@20',                         'foreign'=>'posts@id!post_title');
	public $postmeta_cat    = array('null' =>'NO',  'show' =>'YES', 'label'=>'cat',           'type' => 'varchar@50',                        );
	public $postmeta_key    = array('null' =>'NO',  'show' =>'YES', 'label'=>'key',           'type' => 'varchar@100',                       );
	...
	{
		$this->form("select")->name("post_")->min(0)->max(99999999999999999999)->required()->type("select")->validate()->id();
		$this->setChild();
	}
