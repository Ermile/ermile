...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2015 at 12:45 AM
...
(2, 'en', 'post1', 'post1', 'salam. post1 ast', 'post', 'test/post1', 'open', NULL, 'publish', NULL, 150, NULL, '2015-04-28 18:45:04');
...
(1, NULL, 'tag', 'news', 'news', '', 'news', NULL, NULL, 'enable', '2015-04-28 22:35:48'),
(5, NULL, 'tag', 'test', 'test', 't', 'test', NULL, NULL, 'enable', '2015-04-28 22:35:52'),
(7, NULL, 'tag', 'tag1', 'tag1', '', 'tag1', NULL, NULL, 'enable', '2015-04-28 22:35:56');
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `mobile_unique` (`user_mobile`) USING BTREE, ADD UNIQUE KEY `email_unique` (`user_email`) USING BTREE, ADD KEY `users_permissions_id` (`user_permission`);
