...
private function transtext()
{
	...
	echo T_("Jibres");                                                                // Line 13 Seperate
	echo T_("Azvir");                                                                 // Line 14 Seperate
	...
	echo T_("Ermile team which is made by young proficient people, pleasant environment, dynamic and energetic sincere motivate for those who are interested at co-operate.");// Line 26
	...
	echo T_("Send CV");                                                               // Line 102
	echo T_("Initial Interview");                                                     // Line 111
	echo T_("Specialized Interview");                                                 // Line 124
	echo T_("Final agreement");                                                       // Line 133
	echo T_("Motive is the major factor for any person to be successful in work and that demands enthusiastic, keen and eager people that can help us reach our goal");// Line 155
	echo T_("Lofty projects need great thoughts and these great thoughts help us to reach valuable And huge goals.");// Line 158
	echo T_("And that demands enthusiastic, keen and eager people that can help us reach our goal");// Line 158
	echo T_("We all are always trying to make Ermile’s working environment as a pleasant, energetic and successful place for our team.");// Line 161
	echo T_("Working as a teamwork in Ermile helps us to acquire more power to reach our great aims.");// Line 164
	echo T_("Having creative and self-starter colleagues helps us to step quickly towards our goals.");// Line 167
	echo T_("Be a coworker who is ingenious cause us to do our project fast.");       // Line 170
	echo T_("Age does not matter for us. Having the above qualities are enough to be a member of Email.");// Line 183
