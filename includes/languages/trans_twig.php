...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Steps to join Ermile");                                                  // Line 135
	echo T_("Send CV");                                                               // Line 141
	echo T_("Initial Interview");                                                     // Line 150
	echo T_("Specialized Interview");                                                 // Line 163
	echo T_("Final agreement");                                                       // Line 172
	echo T_("Motive is the major factor for any person to be successful in work and that demands enthusiastic, keen and eager people that can help us reach our goal");// Line 194
	echo T_("Lofty projects need great thoughts and these great thoughts help us to reach valuable And huge goals.");// Line 197
	echo T_("And that demands enthusiastic, keen and eager people that can help us reach our goal");// Line 197
	echo T_("We all are always trying to make Ermile’s working environment as a pleasant, energetic and successful place for our team.");// Line 200
	echo T_("Working as a teamwork in Ermile helps us to acquire more power to reach our great aims.");// Line 203
	echo T_("Having creative and self-starter colleagues helps us to step quickly towards our goals.");// Line 206
	echo T_("Be a coworker who is ingenious cause us to do our project fast.");       // Line 209
	echo T_("Age does not matter for us. Having the above qualities are enough to be a member of Email.");// Line 222
	echo T_("Academic certificates are not important for us. Having a good and well knowledge about the related subject is enough for us.");// Line 225
	echo T_("Job opportunity in Ermile");                                             // Line 237
	echo T_("PHP developer");                                                         // Line 238
	echo T_("JavaScript developer");                                                  // Line 239
	echo T_("Graphic Designer");                                                      // Line 240
	echo T_("Expert in PHP and ability to analyze the codes");                        // Line 247
	echo T_("Familiar with some PHP frameworks");                                     // Line 248
	echo T_("Familiar with OOP and MVC");                                             // Line 249
	echo T_("Familiar with database");                                                // Line 260
	echo T_("Familiar with Git");                                                     // Line 261
	echo T_("Creative and systematic");                                               // Line 274
	echo T_("Fall in love with Documentation");                                       // Line 263
	echo T_("Send cv");                                                               // Line 275
	echo T_("Expert in Html, Css, JavaScript and ability to analyze codes");          // Line 257
	echo T_("Familiar with JavaScript frameworks");                                   // Line 258
	echo T_("Familiar with UX");                                                      // Line 259
	echo T_("Ability of designing professionally(Logo and illustration)");            // Line 267
	echo T_("Familiar with Adobe Photoshop");                                         // Line 268
	echo T_("Familiar with Adobe Illustrator");                                       // Line 269
	echo T_("Familiar with essential traditional Iranian and Islamic art");           // Line 270
	echo T_("Familiar with graphic basics");                                          // Line 271
	echo T_("Familiar with web and user interface");                                  // Line 272
	echo T_("Familiar with color");                                                   // Line 273
	echo T_("Be sure your CV must contain...!");                                      // Line 289
	echo T_("Kindly mention your contact number properly so we can contact you easily.");// Line 294
	echo T_("Don’t forget your social network links especially LinkedIn.");           // Line 295
	echo T_("It’s better if your CV is in one page and be sure it should not be more than 3 pages.");// Line 296
	echo T_("Writing about your experience and your skills in your CV helps us to check your CV properly and hastily.");// Line 297
	echo T_("If you have any work experience, kindly provide complete information about it in your CV.");// Line 298
	echo T_("Be sure to mention your personal information, picture and Interests.");  // Line 299
	echo T_("Please note down your CV with a suitable font and it should be in pdf file.");// Line 300
	echo T_("#614, Omranieh, Moallem St, Qom, Iran");                                 // Line 320
	echo T_("+98 25 3773 5183");                                                      // Line 322
	echo T_("Kindly register your Information");                                      // Line 340
	echo T_("Name");                                                                  // Line 19
	echo T_("Mobile");                                                                // Line 23
	echo T_("Upload CV");                                                             // Line 345
	echo T_("Send your Information");                                                 // Line 347
